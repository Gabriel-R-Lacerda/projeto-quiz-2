class Question {
  ...
  display(){
    ...
    this.question.html("Pergunta: - o que pode ser tocado, não pode ser quebrado e nem destruido <br> porém pode ser facilmente atravessado. " );
    this.question.position(150, 50);
    this.option1.html("1: ar " );
    this.option1.position(150, 100);
    this.option2.html("2: água" );
    this.option2.position(150, 120);
    this.option3.html("3: vidro" );
    this.option3.position(150, 140);
    this.option4.html("4: wi-fi " );
